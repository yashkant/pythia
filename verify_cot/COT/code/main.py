...
if use_custom:
    print('Using Custom Loss for Training')
...
custom_complement_criterion = ComplementEntropyCustom()
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        if args.COT:
            ...
            custom_loss = custom_complement_criterion(outputs, targets)

            # print("Authors' Loss: ", loss.item(),
            #       "Custom Loss: ", custom_loss.item(),
            #       "Difference: ", loss.item()-custom_loss.item())
