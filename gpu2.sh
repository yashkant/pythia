...
CUDA_VISIBLE_DEVICES=2,3 python train.py --config_overwrite '{data:{image_fast_reader:false}, use_complement_loss:false, loss:"combinedLoss", weight_softmax:0.0, weight_complement:100.0, weight_complement_decay:true, weight_complement_decay_factor:0.1, weight_complement_decay_iters:2000}'
